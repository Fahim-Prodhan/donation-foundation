      ...
      <nav className=" bg-[#007F73] ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex lg:order-2 space-x-3 lg:space-x-0 rtl:space-x-reverse">
            ...
            <div className={`flex items-center space-x-3 gap-2`}>
              ...
              {
                authUser && <Link className="hidden md:flex" to="/donate">
                  <button
                    type="button"
                    className="text-[#fff] hover:bg-green-600 bg-green-500 rounded-[50px]  focus:ring-4 focus:outline-none font-medium text-sm px-4 py-2 text-center "
                  >
                    Donate Now
                  </button>
                </Link>
              ...
              {authUser &&
                <div className="dropdown hidden md:block z-50 dropdown-bottom dropdown-end">
                  <div tabIndex={0} role="button" className="m-1">
                    <div className="tooltip tooltip-left avatar cursor-pointer" data-tooltip-id="my-tooltip" data-tooltip-content={''}>
                      <div className="w-12 rounded-full border-2 border-gray-600">
                        <img className="" src={authUser?.profilePic} />
                      </div>
                    </div>
                  </div>
                  <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                    {
                      ...
                      <li><Link className="mb-2 text-[#fff] font-medium hover:bg-[#0aa9ff] bg-[#0aa9ff] rounded-[10px] text-sm" to='/admin/dashboard'>Dashboard</Link></li>

                    }
                    <li>
                      <Link to='/my-profile' className="text-[#fff] font-medium hover:bg-[#fcc41c] bg-[#FFA62F] rounded-[10px] text-sm"> My Profile </Link>
                    </li>
                    <li>
                      <Link className="md:flex mt-2 text-white bg-[#FF6D60] hover:bg-[#ff988f] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 text-center"
        ...
        <div className={`lg:hidden fixed p-6 z-[99] duration-500 md:w-[50%] w-[60%] h-screen top-0 text-white bg-[#007F73] ${hamburger ? "right-0" : "right-[-350px] md:right-[-700px]"}`}>
          ...
          <Link to="/donate">
            <button
              type="button"
              className="text-[#fff] font-medium hover:bg-[#099c6b] bg-[#03C988] rounded-[10px]  focus:ring-4 focus:outline-none text-sm px-4 py-2 text-center mt-4 lg:hidden block"
            >
              Donate Now
            </button>
          </Link>

          {
            authUser && authUser.role == 'admin' && <div className={`mt-6`}>
              <Link to="/admin/dashboard">
                <button
                  type="button"
                  className="text-[#fff] font-medium hover:bg-[#0aa9ff] bg-[#0aa9ff] rounded-lg focus:ring-4 focus:outline-none text-sm px-4 py-2 text-center"
                >
                  Dashboard
                </button>
              </Link>
          ...
          {
            authUser && <Link to='/my-profile'>
              <button
                type="button"
                className="mt-4 text-[#fff] font-medium hover:bg-[#fcc41c] bg-[#FFA62F] rounded-[10px] focus:ring-4 focus:outline-none text-sm px-4 py-2 text-center"
              >
                My Profile
              </button>
            </Link>
